...
for reg in ${registries[@]}; do
  ...
  mkdir -p ${microk8s_certs_path}/${reg} && cat > ${microk8s_certs_path}/${reg}/hosts.toml <<EOF
[host."${proxy_host}"]
